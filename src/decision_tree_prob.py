...
import numpy as np
import pandas as pd
from handler_prob_predictor import ProbabilisticPredictor


class Node():
    def __init__(self, feature_index=None, threshold=None, left=None, left_dataset=None, right=None,
                 right_dataset=None,
                 info_gain=None, value=None, final_leaf_dataset=None):
        # for decision node
...
class OurTree():
        ...
        if num_samples >= self.min_samples_split and curr_depth <= self.max_depth:
            ...
            if best_split["info_gain"] > 0:
                ...
                return Node(best_split["feature_index"], best_split["threshold"],
                            left_subtree, best_split["dataset_left"], right_subtree, best_split["dataset_right"],
    ...
    def make_prediction(self, x, tree, probability=1):
        ...
        if not self.is_missing(feature_val):
            ...
            prob_predict.fill_prob_dictionary(x, tree)
            return prob_predict.most_possible_value()
